package com.github.tide.demo.order;

import cn.hutool.json.JSONUtil;
import com.github.tide.demo.fail.SendMessageFallbackHandler;
...
public class SendMessageComponent {
    ...
    @ConsistencyTask(
            ...
            threadWay = ThreadWayEnum.ASYNC,
            fallbackClass = SendMessageFallbackHandler.class,
            alertActionBeanName = "normalAlerter" // normalAlerter就是 com.github.tide.alertm.NormalAlerter类在spring容器中的beanName
    )
