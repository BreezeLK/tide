...
@NoArgsConstructor
@AllArgsConstructor
@ConfigurationProperties(prefix = "tide.tend.consistency.parallel.pool")
public class TendConsistencyParallelTaskConfigProperties {
    ...
    /**
     * 这里要配置类型全路径且类要实现com.github.tide.custom.query.TaskTimeRangeQuery接口 如：com.xxx.TaskTimeLineQuery
     */
