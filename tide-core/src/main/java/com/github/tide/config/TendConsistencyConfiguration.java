...
public class TendConsistencyConfiguration {
    ...
    /**
     * 这里要配置类型全路径且类要实现com.github.tide.query.TaskTimeRangeQuery接口 如：com.xxx.TaskTimeLineQuery
     */
    private String taskScheduleTimeRangeClassName = "";
    /**
     * 生成任务表分片key的ClassName 这里要配置类型全路径且类要实现com.github.tide.custom.shard.ShardingKeyGenerator接口
     */
